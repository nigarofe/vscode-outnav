...
function activate(context) {
    context.subscriptions.push(vscode.commands.registerCommand('vscode-outnav.startOutlineNavigator', async () => {
...
function deactivate() { }
async function findWorkspaceFolderWithOutlines() {
...
async function parseOutlinesMd(filePath) {
...
function openOutlineWebview(context, outlines, workspaceFolder) {
    ...
    function convertLocalSrcs(node) {
        ...
        if (node.children) {
            node.children.forEach(convertLocalSrcs);
        }
    }
...
function getWebviewContent(webview, outlines) {
